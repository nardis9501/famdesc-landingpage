    ...
    <>
      ...
      >
        <section className="md:grid grid-cols-2 h-full max-w-[1300px] px-2">
          <div className="absolute top-0 left-0 mt-24 sm:mt-32 px-4 md:mt-0  md:relative z-10 flex flex-col h-full w-full">
            <h1
          ...
          <div className="md:grid place-content-end drop-shadow-xl hidden">
            <Image
